...
function App() {
    ...
    const moves = history.map((step, move) => {
        ...
        return (
            <li key={move}>
                {move === stepNumber ? (
                    <div>You are at move #{move} ({step.location[1]+1}, {step.location[0]+1})</div>
                ) : (
            ...
            <div className="game-container">
                ...
                <div className="game-info">
                    ...
                    <div className="button-container">
                        <button className="sort-button" onClick={toggleSort}>Sort moves</button>
                        {isGameOver && <button className="restart-button" onClick={restartGame}>Restart game</button>}
                    </div>
                    <ol>{moves}</ol>
                </div>
            </div>
